...
get_test_data_credential_path = os.path.join(project_path, r"data/testdata_credentials.csv")

# get test data yaml path
get_test_data_yaml_path = os.path.join(project_path, r"data/test_data.yaml")
